                        ...
                        <div className="bg-dark text-white rounded-2xl">
                            <div className="text-center p-5">
                                ...
                                <div className="pb-5 mt-4 mb-5">
                                    ...
                                    <h2 className="mb-2 mt-6 font-bold uppercase text-3xl">cadastro</h2>
                                    ...
                                    <Link href="/auth"><button className=" outline outline-2 rounded-sm px-14 py-2 outline-white px5 w-lg hover:bg-slate-50 hover:bg-opacity-10" type="submit">Logar</button></Link>
